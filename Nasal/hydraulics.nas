...
var hydraulics = {
	...
	blue: {
		...
		update: func
		{
			...
			if ((hydraulics.blue.serviceable.getBoolValue() and (hydraulics.blue.pump.getBoolValue())
			     or hydraulics.auxilary_pump.getBoolValue()))
			{
	...
	green: {
		...
		update: func
		{
			...
			if (hydraulics.green.serviceable.getBoolValue() and
			    (hydraulics.green.pump.getBoolValue() or (hydraulics.auxilary_pump.getBoolValue() and hydraulics.xfeed.getBoolValue())))
			{
